            ...
            <div class="col-md-12 d-flex justify-content-center">
                ...
                <div class="card card-primary">
                    <div class=" d-flex justify-content-center" >
                        <h3 class="card-title" style="margin-top:10px;margin-bottom: 0px;">Editar Cliente</h3>
                    </div>
                    ...
                    <form>
                        ...
                        <!-- /.card-body -->
                        <div style="display: grid; grid-template-columns: 3fr 0fr;">
                            <div class="card-footer">
                                <button type="submit" class="btn" style="background-color: #202126; color: #F7F4ED;">Cancelar</button>
                            </div>
                            <div class="card-footer">
                                <button type="submit" class="btn" style="background-color: #fffffc; color: #202126; border-color:black; border-radius: 4px">Guardar </button>
                            </div>
                        </div>
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-center">
                            <h4>
                                <i class="fas fa-globe"></i> Facturas
                            </h4>
                        </div>
                        <!-- /.col -->
                    </div>
