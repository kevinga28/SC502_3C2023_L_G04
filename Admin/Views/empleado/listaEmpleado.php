                        ...
                        <table id="tabla" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="tabla_info">
                          <thead>
                            <tr>
                              ...
                              <th class="sorting" tabindex="0" aria-controls="tabla" rowspan="1" colspan="1" aria-label="Correo: activate to sort column ascending">Correo</th>
                              <th class="sorting" tabindex="0" aria-controls="tabla" rowspan="1" colspan="1" aria-label="Telefono: activate to sort column ascending">Telefono</th>
                              <th class="sorting" tabindex="0" aria-controls="tabla" rowspan="1" colspan="1" aria-label="Rol: activate to sort column ascending">Rol</th>
                              <th></th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr class="odd">
                              ...
                              <td>
                                ...
                                <a type="button" class="btn btn-success float-right" style="margin-right: 8px;" href="editarEmpleado.php">
                                  <i class="fas fa-pencil-alt"></i> Editar
                                </a>
                                <a type="button" class="btn btn-primary float-right" style="margin-right: 8px;" href="verEmpleado.php">
